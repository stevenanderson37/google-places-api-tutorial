...
// RETRIEVES THE JSON OBJECT OF THE CITY OR ZIP CODE USING THE GOOGLE GEOCODE API. CAN PULL THE NEEDED INFORMATION FROM IT.
// var getJSON = function(url, callback) {
//   var xhr = new XMLHttpRequest();
//   xhr.open('GET', 'https://maps.googleapis.com/maps/api/geocode/json?' + url + '&key=AIzaSyC0u484plSsbaG9A8JEtRyYBNhnhgReop8', true);
